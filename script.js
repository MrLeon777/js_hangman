...
"макака","компьютер","клавиатура", "программа", "катастофа", "макака", "прекрасный", "динозавр", "компьютер", "оладушек", "индекс",
"школа", "интроверт", "вертолёт", "институт", "природа", "алфавит", "мумия", "почемучка", "верба", "гомодрил", "куратор", "поле",
"исполнитель", "закзчик", "альтернатива", "кавычки", "строка", "ноль", "животноводство", "абсолютный", "леночка"
];
